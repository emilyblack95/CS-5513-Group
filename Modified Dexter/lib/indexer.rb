# Original Author: Andrew Kane
# Modified by: Emily Black, 04/24/18
module Dexter
  class Indexer
    include Logging
    ...
    # compares the new index set from Dexter's algorithm with Zaman's algorithm, takes the intersection of both.
    # TODO: EDIT THIS
